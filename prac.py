...
# # 🚀 The Coding Task: "Smart Home System"
# To test your skills, build a mini Smart Home Device System. This will require you to use all the concepts you've outlined.

# The Requirements:
# Abstraction: Create an abstract class DeviceTemplate that requires two methods: turn_on() and status().

# Inheritance: Create a base class SmartDevice (inheriting from the template) that takes brand and model in its constructor.

# Encapsulation: * Add a private attribute __is_on (a boolean) set to False by default.

# Add a private attribute __energy_usage (an integer).

# Polymorphism: Create two child classes: SmartLight and SmartThermostat.

# For SmartLight, the status() method should return if the light is on and its brightness level.
